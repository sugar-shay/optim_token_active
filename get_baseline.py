# -*- coding: utf-8 -*-
"""
Created on Fri Sep 17 16:11:18 2021
...
def main(data_dir, category='memc'):
    ...
    model.load_state_dict(torch.load('bert_baseline_memc.pt'))
